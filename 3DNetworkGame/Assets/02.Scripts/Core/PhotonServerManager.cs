...
public class PhotonServerManager : MonoBehaviourPunCallbacks
{
    ...
    private string _nickname = "hyeonjong";
    ...
    private void Start()
    {
        ...
        // 방장이 씬을 옮기면 다른 사람들도 자동으로 옮겨진다. => true
    ...
    public override void OnConnectedToMaster()
    {
        ...
        //TypedLobby lobby = new TypedLobby("Channel3", LobbyType.Default);
    ...
    //랜덤 방 입장에 실패하면 자동으로 호출되는 콜백함수
    public override void OnJoinRandomFailed(short returnCode, string message)
    {
        Debug.Log($"랜덤 방 입장에 실패했습니다:{returnCode} - {message}");

        //랜덤 룸 입장에 실패하면.. 룸이 하나도 없는 것이지... 룸을 만들자!
